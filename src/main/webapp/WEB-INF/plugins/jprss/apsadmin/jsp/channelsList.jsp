        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="table-w-15"><s:text name="contentType" /></th>
                    <th class="table-w-10"><s:text name="feedType" /></th>
                    <th class="table-w-5"><s:text name="status" /></th>
                    <th class="table-w-5"><s:text name="active" /></th>
            ...
            <tbody>
                <s:iterator value="#channelsVar" var="channelVar">
                    <tr class="dl-horizontal dl-striped panel padding-base-top padding-base-bottom">
                        <td>
                            <s:property value="#channelVar.title" />
                        </td>
                        <td>
                            <s:property value="#channelVar.description" />
                        </td>
                        <td>
                            <s:property value="%{getSmallContentType(#channelVar.contentType).descr}" />
                        </td>
                        <td>
                            <s:property value="%{getAvailableFeedTypes()[#channelVar.feedType]}" />
                        </td>
...
<a href="<s:url namespace="/do/jprss/Rss" action="new" />" class="btn btn-primary pull-right mb-5">
